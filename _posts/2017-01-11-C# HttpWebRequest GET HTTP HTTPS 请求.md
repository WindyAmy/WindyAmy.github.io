---
layout: post
title: C#中用HttpWebRequest中发送GET/HTTP/HTTPS请求
date: 2017-01-11 
tags: 知识分享   
---
# C#中用HttpWebRequest中发送GET/HTTP/HTTPS请求 #
> [参考地址](http://www.cnblogs.com/txw1958/archive/2013/01/11/Csharp-HttpWebRequest-GET-HTTP-HTTPS.html "参考地址")
> http://www.cnblogs.com/txw1958/archive/2013/01/11/Csharp-HttpWebRequest-GET-HTTP-HTTPS.html
```
    using System;
